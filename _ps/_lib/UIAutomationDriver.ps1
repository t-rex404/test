...
class UIAutomationDriver
{
    ...
    [void] LogInfo([string]$message)
    {
        if ($global:Common)
        {
            try
            {
                $global:Common.WriteLog($message, "INFO", "UIAutomationDriver")
            }
            catch
            {
        ...
        else
        {
            ...
            $this.AppendTextNoBom(([UIAutomationDriver]::NormalLogFile), $line + [Environment]::NewLine)
        }
    ...
    [void] LogError([string]$errorCode, [string]$message)
    {
        ...
        {
            $line = "[$(Get-Date -Format 'yyyy/MM/dd HH:mm:ss')] $message"
            $this.AppendTextNoBom(([UIAutomationDriver]::ErrorLogFile), $line + [Environment]::NewLine)
        }
