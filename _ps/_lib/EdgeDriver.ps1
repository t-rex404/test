class EdgeDriver : WebDriver
{
    ...
    [void] LogInfo([string]$message)
    {
        if ($global:Common)
        {
            try
            {
                $global:Common.WriteLog($message, "INFO", "EdgeDriver")
            }
            catch
            {
        ...
        else
        {
            ...
            $this.AppendTextNoBom(([EdgeDriver]::NormalLogFile), $line + [Environment]::NewLine)
        }
    ...
    [void] LogError([string]$errorCode, [string]$message)
    {
        ...
        {
            $line = "[$(Get-Date -Format 'yyyy/MM/dd HH:mm:ss')] $message"
            $this.AppendTextNoBom(([EdgeDriver]::ErrorLogFile), $line + [Environment]::NewLine)
        }
